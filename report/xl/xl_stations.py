...
def create_stations_dataframe(head_dataframe, campaigns_dict, measurepoint_list, agency_code_list):
    ...
    columns=['Type de réseau', 'Hydroécorégion', 'Masse d\'eau', 'Adresse', 'Coordonnées de référence', 'Coordonnées de référence (Lambert 93)', 'Coordonnées réelles', 'Coordonnées réelles (Lambert 93)']
