...
def run():
  ...
  r2_constant_table = QueryScript("DROP TABLE IF EXISTS r2_constant; CREATE TABLE r2_constant (id INT AUTO_INCREMENT PRIMARY KEY, nature VARCHAR(255), name VARCHAR(255), value VARCHAR(255))")
