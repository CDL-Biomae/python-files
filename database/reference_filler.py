...
def run():
  ...
  QueryScript(f" DROP TABLE IF EXISTS r1").execute(True)
  ...
  r1_table.execute(True)
  SQL_request = f" INSERT INTO r1 (parameter, min, max, version) VALUES (%s, %s, %s, %s)"
  values = []
  index=1
  is_readable = True
  while is_readable :
  ...
  QueryScript(f" DROP TABLE IF EXISTS r2_constant").execute(True)
  ...
  r2_constant_table.execute(True)
  SQL_request = f" INSERT INTO r2_constant (nature, name, value, version) VALUES (%s, %s, %s, %s)"
  values = []
  index=1
  current_nature = ''
  is_readable =True
  ...
  QueryScript(f" DROP TABLE IF EXISTS r2_threshold").execute(True)
  ...
  r2_threshold_table.execute(True)
  SQL_request = f" INSERT INTO r2_threshold (parameter, population, type, time, threshold, unit, rule, meaning, version) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
  values = []
  index=1
  is_readable = True
  while is_readable :
  ...
  QueryScript(f" DROP TABLE IF EXISTS r3").execute(True)
  ...
  r3_table.execute(True)
  SQL_request = f" INSERT INTO r3 (unit, sandre, parameter, NQE, 7j_threshold, 7j_graduate_25, 7j_graduate_50, 7j_graduate_75, 21j_threshold, 21j_graduate_25, 21j_graduate_50, 21j_graduate_75, case_number, familly, maximum, freq_quanti, version) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
  values = []
  index=0
  is_readable=True
  while is_readable :
