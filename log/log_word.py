                ...
                if "min_conductivity_chemistry" in place_dict[place_id]["not conform"] or "max_conductivity_chemistry" in place_dict[place_id]["not conform"] or "min_conductivity_tox" in place_dict[place_id]["not conform"] or "max_conductivity_tox" in place_dict[place_id]["not conform"]:
                    ...
                    if "min_conductivity_chemistry" in place_dict[place_id]["not conform"] or "min_conductivity_tox" in place_dict[place_id]["not conform"] :
                        if "min_conductivity_chemistry" in place_dict[place_id]["not conform"] and not "min_conductivity_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("conductivité : chimie")
                        if not "min_conductivity_chemistry" in place_dict[place_id]["not conform"] and "min_conductivity_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("conductivité : toxicité")
                        if "min_conductivity_chemistry" in place_dict[place_id]["not conform"] and "min_conductivity_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("conductivité : chimie et toxicité")
                    if "max_conductivity_chemistry" in place_dict[place_id]["not conform"] or "max_conductivity_tox" in place_dict[place_id]["not conform"] :
                        ...
                        if "max_conductivity_chemistry" in place_dict[place_id]["not conform"] and "max_conductivity_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("conductivité : chimie et toxicité")
                if "max_temperature_chemistry" in place_dict[place_id]["not conform"] or "min_average_temperature_chemistry" in place_dict[place_id]["not conform"] or "max_average_temperature_chemistry" in place_dict[place_id]["not conform"] or "min_temperature_alimentation" in place_dict[place_id]["not conform"] or "max_temperature_alimentation" in place_dict[place_id]["not conform"] or "min_temperature_reproduction" in place_dict[place_id]["not conform"] or "max_temperature_reproduction" in place_dict[place_id]["not conform"]:
                    temperature_not_conform_number +=1
                    if "min_average_temperature_chemistry" in place_dict[place_id]["not conform"] or "min_temperature_alimentation" in place_dict[place_id]["not conform"]  :
                        if "min_average_temperature_chemistry" in place_dict[place_id]["not conform"] and not "min_temperature_alimentation" in place_dict[place_id]["not conform"] and not "min_temperature_reproduction" in place_dict[place_id]["not conform"]  :
                            not_conform_explination += f"La température moyenne est inférieure aux recommandations pour l’encagement de gammares dans le cadre du biotest de chimie (mesurée {str(round(place_dict[place_id]['condition']['chemistry_average_temperature_min'],1)).replace('.',',')} pour min. 1 °C). "
                            not_conform_type_list.append("température : chimie")
                        if not "min_average_temperature_chemistry" in place_dict[place_id]["not conform"] and "min_temperature_alimentation" in place_dict[place_id]["not conform"] and not "min_temperature_reproduction" in place_dict[place_id]["not conform"]:
                            not_conform_explination += f"La température moyenne est inférieure aux recommandations pour l’encagement de gammares dans le cadre des biotests de toxicité (mesurée {str(round(place_dict[place_id]['condition']['alimentation_average_temperature_min'],1)).replace('.',',')} pour min. 7 °C). "
                            not_conform_type_list.append("température : toxicité")
                        if not "min_average_temperature_chemistry" in place_dict[place_id]["not conform"] and not "min_temperature_alimentation" in place_dict[place_id]["not conform"] and "min_temperature_reproduction" in place_dict[place_id]["not conform"]:
                            not_conform_explination += f"La température moyenne est inférieure aux recommandations pour l’encagement de gammares dans le cadre des biotests de toxicité (mesurée {str(round(place_dict[place_id]['condition']['reproduction_average_temperature_min'],1)).replace('.',',')} pour min. 7 °C). "
                            not_conform_type_list.append("température : toxicité")
                        if "min_average_temperature_chemistry" in place_dict[place_id]["not conform"] and "min_temperature_alimentation" in place_dict[place_id]["not conform"] and "min_temperature_reproduction" in place_dict[place_id]["not conform"] :
                            not_conform_explination += f"La température moyenne est inférieure aux recommandations pour l’encagement de gammares dans le cadre des biotests de chimie et de toxicité (mesurée {str(round(place_dict[place_id]['condition']['average_temperature'],1)).replace('.',',')} pour min. 1 °C). "
                            not_conform_type_list.append("température : chimie et toxicité")
                    if "max_temperature_chemistry" in place_dict[place_id]["not conform"] or "max_average_temperature_chemistry" in place_dict[place_id]["not conform"] or "max_temperature_alimentation" in place_dict[place_id]["not conform"]  :
                        if not "max_temperature_chemistry" in place_dict[place_id]["not conform"] and "max_average_temperature_chemistry" in place_dict[place_id]["not conform"] and not "max_temperature_alimentation" in place_dict[place_id]["not conform"] and not "max_temperature_reproduction" in place_dict[place_id]["not conform"]  :
                            not_conform_explination += f"La température moyenne est supérieure aux recommandations pour l’encagement de gammares dans le cadre du biotest de chimie (mesurée {str(round(place_dict[place_id]['condition']['chemistry_average_temperature_max'],1)).replace('.',',')} pour max. 18 °C). "
                            not_conform_type_list.append("température : chimie")
                        if "max_temperature_chemistry" in place_dict[place_id]["not conform"] and not "max_average_temperature_chemistry" in place_dict[place_id]["not conform"] and not "max_temperature_alimentation" in place_dict[place_id]["not conform"] and not "max_temperature_reproduction" in place_dict[place_id]["not conform"]  :
                            not_conform_explination += f"La température maximale est supérieure aux recommandations pour l’encagement de gammares dans le cadre du biotest de chimie (mesurée {str(round(place_dict[place_id]['condition']['chemistry_temperature_max'],1)).replace('.',',')} pour max. 21 °C). "
                            not_conform_type_list.append("température : chimie")
                        if "max_temperature_chemistry" in place_dict[place_id]["not conform"] and "max_average_temperature_chemistry" in place_dict[place_id]["not conform"] and not "max_temperature_alimentation" in place_dict[place_id]["not conform"] and not "max_temperature_reproduction" in place_dict[place_id]["not conform"]  :
                            not_conform_explination += f"Les températures maximale et moyenne sont supérieures aux recommandations pour l’encagement de gammares dans le cadre du biotest de chimie (mesurée {str(round(place_dict[place_id]['condition']['chemistry_average_temperature_max'],1)).replace('.',',')} pour max. 18 °C pour la moyenne et mesurée {str(round(place_dict[place_id]['condition']['chemistry_temperature_max'],1)).replace('.',',')} pour max. 21 °C pour la maximale). "
                            not_conform_type_list.append("température : chimie")
                        if not "max_temperature_chemistry" in place_dict[place_id]["not conform"] and not "max_average_temperature_chemistry" in place_dict[place_id]["not conform"] and "max_temperature_alimentation" in place_dict[place_id]["not conform"] and not "max_temperature_reproduction" in place_dict[place_id]["not conform"]:
                            not_conform_explination += f"La température moyenne est supérieure aux recommandations pour l’encagement de gammares dans le cadre des biotests de toxicité (mesurée {str(round(place_dict[place_id]['condition']['alimentation_average_temperature_max'],1)).replace('.',',')} pour max. 20 °C). "
                            not_conform_type_list.append("température : toxicité")
                        if not "max_temperature_chemistry" in place_dict[place_id]["not conform"] and not "max_average_temperature_chemistry" in place_dict[place_id]["not conform"] and not "max_temperature_alimentation" in place_dict[place_id]["not conform"] and "max_temperature_reproduction" in place_dict[place_id]["not conform"]:
                            not_conform_explination += f"La température moyenne est supérieure aux recommandations pour l’encagement de gammares dans le cadre des biotests de toxicité (mesurée {str(round(place_dict[place_id]['condition']['reproduction_average_temperature_max'],1)).replace('.',',')} pour max. 20 °C). "
                            not_conform_type_list.append("température : toxicité")
                        if not "max_temperature_chemistry" in place_dict[place_id]["not conform"] and "max_average_temperature_chemistry" in place_dict[place_id]["not conform"] and "max_temperature_alimentation" in place_dict[place_id]["not conform"] and "max_temperature_reproduction" in place_dict[place_id]["not conform"] :
                            not_conform_explination += f"La température moyenne est supérieure aux recommandations pour l’encagement de gammares dans le cadre des biotests de chimie et de toxicité (mesurée {str(round(place_dict[place_id]['condition']['average_temperature'],1)).replace('.',',')} pour max. 20 °C). "
                            not_conform_type_list.append("température : chimie et toxicité")
                ...
                if "min_ph_chemistry" in place_dict[place_id]["not conform"] or "max_ph_chemistry" in place_dict[place_id]["not conform"] or "min_ph_tox" in place_dict[place_id]["not conform"] or "max_ph_tox" in place_dict[place_id]["not conform"]:
                    ...
                    if "min_ph_chemistry" in place_dict[place_id]["not conform"] or "min_ph_tox" in place_dict[place_id]["not conform"] :
                        if "min_ph_chemistry" in place_dict[place_id]["not conform"] and not "min_ph_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("ph : chimie")
                        if not "min_ph_chemistry" in place_dict[place_id]["not conform"] and "min_ph_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("ph : toxicté")
                        if "min_ph_chemistry" in place_dict[place_id]["not conform"] and "min_ph_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("ph : chimie et toxicité")
                ...
                if "oxygen_chemistry" in place_dict[place_id]["not conform"] or "oxygen_tox" in place_dict[place_id]["not conform"]:
                    ...
                    if "oxygen_chemistry" in place_dict[place_id]["not conform"] or "oxygen_tox" in place_dict[place_id]["not conform"] :
                        if "oxygen_chemistry" in place_dict[place_id]["not conform"] and not "oxygen_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("oxygène : chimie")
                        if not "oxygen_chemistry" in place_dict[place_id]["not conform"] and "oxygen_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("oxygène : toxicité")
                        if "oxygen_chemistry" in place_dict[place_id]["not conform"] and "oxygen_tox" in place_dict[place_id]["not conform"] :
                            ...
                            not_conform_type_list.append("oxygène : chimie et toxicité")
                precision = ' ('
